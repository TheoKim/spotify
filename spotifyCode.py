...
# Interpretation: The "chronoception" of a song. How fast is the song? Does it overstay its welcome (too long)?
...
ax.set_zlabel('Principal Component 3: "Chronoception"')
